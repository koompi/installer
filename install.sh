...
Welcome to the PIONUX installer!

In order to install PIONUX you will need to:
...
WARNING: Installing PIONUX will wipe all your personal data
...
Please contact us at rithy@procambodia.com with the issue you are facing and we'll
...
Are you running this install script outside the directory you unzipped PIONUX in?
...
The first boot will take 2-3 mins as PIONUX sets up your device so please be
patient.

Rebooting into PIONUX...
EOF
}
...
mecho -n "Are you ready to install PIONUX? (yes/no): "
read response
mecho
...
# point of no return!
mecho
mecho "Installing PIONUX, please keep your device connected..."
