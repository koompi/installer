...
ECHO.
ECHO Welcome to the PIONUX Uninstaller.
ECHO.
ECHO This script will ease the process of restoring your
ECHO device to factory settings.
ECHO.
ECHO In order to uninstall PIONUX you will need to:
ECHO.
...
ECHO.
ECHO WARNING: Uninstalling PIONUX will wipe all your personal data
ECHO so make sure you first back-up anything important!
ECHO.

SET /P confirm="Are you ready to uninstall PIONUX? (yes/no): "
ECHO.
IF NOT "%confirm%"=="yes" (
